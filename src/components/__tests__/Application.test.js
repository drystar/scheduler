...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    const appointment = getAllByTestId(container, "appointments")[0];
    ...
    await waitForElement(() =>
      queryByText(appointment, "Error Saving Appointment")
    );
    expect(
  ...
  it("shows the delete error when failing to save an appointment", async () => {
    ...
    await waitForElement(() =>
      queryByText(appointment, "Error Deleting Appointment")
    );
    expect(
